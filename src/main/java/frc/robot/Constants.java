...
public final class Constants {
  ...
  public static class ElevatorConstants {
    ...
    public static final double coralAlgae_POS = 15; 
  ...
  public static class IntakeConstans {
    ...
    public static class RollerConstants{
      ...
      public static final double ROLLER_IN_SPEED = 0.08;
  ...
  public static class VisionConstants{
    ...
    public static final CameraConfig[] cameraConfigs = new CameraConfig[]{//back top
      ...
      new CameraConfig(//left cam with acrylic
          "2",
          new Transform3d(
