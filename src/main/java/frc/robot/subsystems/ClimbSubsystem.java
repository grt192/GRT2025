...
public class ClimbSubsystem extends SubsystemBase {
  ...
  private SparkMaxConfig topSparkMaxConfig;
  private SparkMaxConfig botSparkMaxConfig;
  ...
  * a @return position of the top motor in rotations after taking the position.
  ...
  * a @return velocity of the top motor in RPM after taking the velocity.
  * conversion factor into account.
  */
  ...
  * a @param speed target speed from -1.0 to 1.0
  */
