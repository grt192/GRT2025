...
public class SwerveSubsystem extends SubsystemBase {
  ...
  * empty @return The array of module positions.
  */
   ...
   * empty @return The array of module states.
   */
  ...
  */
  public Rotation2d getDriverHeading() {
    Rotation2d robotHeading = ahrs.isConnected() ? getGyroHeading() : 
  ...
  */
  ...
  private Rotation2d getGyroHeading() {
    ...
    // Might need to flip depending on the robot setup
  }
