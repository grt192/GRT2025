...
public class DifferentialSetAngleCoralCommand extends Command{

    DiffyArmSubsystem diffyArmSubsystem;
    DiffyState diffyState;

    public void DifferentialSetAngleCoralCommand (DiffyArmSubsystem diffyArmSubsystem) {
        ...
        this.diffyState = DiffyState.ANGLE_CORAL;
    }
